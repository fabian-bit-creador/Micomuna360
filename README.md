...
| 1 | Landing, navegación responsive, componentes base | 🔜 |
| 2 | MVP ciudadano: formulario, mapa, noticias, dashboard, panel admin (datos ficticios) | — |
| 3 | Supabase: auth, tablas, storage, RLS | — |
| 4 | Panel municipal completo: derivaciones, exportación, auditoría | — |
